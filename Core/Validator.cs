...
namespace QBackup.Core
{
    ...
    public static class Validator
    {
        ...
        public static void Validate(
            ...
            bool check_last_write_time = true)
        {
            if (x1 == null || x2 == null)
            {
                if (!(x1 == null && x2 == null))
            ...
            bool check_last_write_time = true)
        {
            ...
            foreach (var dir in dirs) Validate(dir.Item1, dir.Item2, log, check_absolute, check_children, check_last_write_time);
        }
        ...
        public static void Validate(
            AnalyzedBackup backup1,
            ArchivedBackup archived,
            ILog log,
            bool check_absolute_paths,
            bool check_file_contents,
            bool check_last_write_time)
        {
            ...
            Validate(
                backup1.Files, archived.ArchivedDirs.SelectMany(x => x.ArchivedFiles).ToList(), log, check_absolute_paths,
                check_file_contents, check_last_write_time);
        }

        public static void Validate(
            AnalyzedBackup backup1,
            AnalyzedBackup backup2,
            ILog log,
            bool check_absolute_paths,
            bool check_file_contents,
            bool check_last_write_time)
            ...
            bool check_last_write_time = true)
        {
            ...
            foreach (var file in files) Validate(file.Item1, file.Item2, log, check_absolute, check_content, check_last_write_time);
        }
        ...
        private static List<Tuple<T1, T2>> ValidateLists<T1, T2>(
            IList<T1> l1,
            IList<T2> l2,
            Func<T1, string> id_func1,
            Func<T2, string> id_func2,
            ILog log)
        {
            ...
            foreach (var id in not_found_in_both) log.WriteLine($"{id} not found");
